...
- Phase 3G.3 unified timing events and threshold-aware timing analysis are next. One bar-line interaction will own optional downbeat-time and meter corrections; a general undo history remains deferred until the timing model stabilizes.

## Next Recommended Task

Implement Phase 3G.3 unified bar timing and threshold-aware analysis, including the versioned meter-aware event contract and its separate known-answer timing evaluation loop.
