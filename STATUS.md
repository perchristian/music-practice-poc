...
Start Phase 3C: add editable chord chart controls on top of the corrected musical grid. Users should be able to correct analyzer chord suggestions, with edits persisted separately from analyzer output and displayed as the working chart.
