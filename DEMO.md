...
23. In Harmony, select `Reanalyse chords`, read the replacement warning, and confirm. Wait for the status to report how many new chord cues were generated from the corrected timing. The previous working chart is retained as a backend backup.
